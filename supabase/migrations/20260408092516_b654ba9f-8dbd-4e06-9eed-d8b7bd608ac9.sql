...
BEGIN
  ...
  -- EVENT-BASED: shipped count for direct orders (with revert detection)
  ...
  -- EVENT-BASED: dropped count = all orders created in the period (each counted once)
  ...
  -- Cross-invoice shipped — EVENT-BASED (with revert detection)
  ...
  -- UNIFIED shipping breakdown — EVENT-BASED (with revert detection)
  WITH all_shipped AS (
  ...
  -- COD fees = percentage of delivered revenue in USD
