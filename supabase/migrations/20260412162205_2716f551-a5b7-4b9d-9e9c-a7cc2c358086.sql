...
BEGIN
  ...
  -- Cross-invoice shipped (with time-bounded delivery check AND revenue sum)
  ...
  -- Add BOTH cross-delivered counts (from cross-shipped path AND cross-delivered-only path)
