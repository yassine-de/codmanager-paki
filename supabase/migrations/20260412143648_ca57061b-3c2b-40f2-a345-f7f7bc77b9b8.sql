...
BEGIN
  ...
  -- FIX: Added time bounds to the initial EXISTS check for shipped events
  ...
  -- FIX: Added time bounds to the initial EXISTS check for shipping breakdown (first UNION half)
  WITH all_shipped AS (
