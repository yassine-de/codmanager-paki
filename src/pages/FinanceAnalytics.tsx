...
export default function FinanceAnalytics() {
  ...
  const shippedOrders = useMemo(() => {
    return filteredOrders.filter(o => o.delivery_status && ["printed", "dispatched", "shipped", "in_transit", "with_courier", "delivered", "paid", "returned", "return", "ready_for_return", "return_received", "pending"].includes(o.delivery_status));
  }, [filteredOrders]);
  ...
  const profitBySeller = useMemo(() => {
    ...
    filteredOrders.forEach(o => {
      ...
      if (o.delivery_status && ["printed", "dispatched", "shipped", "in_transit", "with_courier", "delivered", "paid", "returned", "return", "ready_for_return", "return_received", "pending"].includes(o.delivery_status)) {
