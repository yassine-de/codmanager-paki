...
import { Plus, Pencil, Trash2, Loader2, Shield, Store, Headphones, UserCog, MessageSquare, Crown } from "lucide-react";
...
const roleConfig: Record<string, { label: string; icon: typeof Shield; color: string }> = {
  ...
  general_manager: { label: "General Manager", icon: Crown, color: "bg-indigo-500/10 text-indigo-600 border-indigo-500/20" },
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <Select value={filterRole} onValueChange={setFilterRole}>
          ...
          <SelectContent>
            ...
            <SelectItem value="general_manager" className="text-xs">General Manager</SelectItem>
