    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card className="lg:col-span-2">
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center justify-between rounded-lg border bg-muted/30 px-3 py-2">
            <div className="min-w-0">
              <div className="text-sm font-medium">Auto-book carrier shipping on confirmation</div>
              <div className="text-[11px] text-muted-foreground">
                {form.auto_book_shipping
                  ? "When an order is confirmed via WhatsApp (button or AI auto-confirm), it is immediately marked Booked and sent to the carrier."
                  : "Confirmed orders stay in the system without being pushed to a carrier. Admins/agents must book shipping manually."}
              </div>
            </div>
            <Switch
